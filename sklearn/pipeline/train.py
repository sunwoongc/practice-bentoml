...
logging.bsicConfig(level=logging.INFO, format="%(asctime)s %(levelname)s %(message)s")
...
pipeline = Pipeline(
    [
        ...
        ("clf", SGDClassifier(loss="log_loss")), # TODO: Why we have separate linear_regression directory?
    ]
)
